...
class HUD:
    def __init__(self, player, screen, skill, move_skill):
        self._player = player
        self._screen = screen
        self._skill = (skill, Text(screen, 16, center_position=(30, 50)))
        self._move_skill = (move_skill, Text(screen, 16, center_position=(70, 50)))
    ...
    def draw(self):
        ...
        self._skill[1].draw(f"{self._skill[0].remaining_cooldown/1000:.1f}")
        self._move_skill[1].draw(f"{self._move_skill[0].remaining_cooldown/1000:.1f}")
